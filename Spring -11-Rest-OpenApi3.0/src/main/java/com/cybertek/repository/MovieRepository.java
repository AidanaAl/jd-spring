...
//    List<Movie> getAllMoviesBYPrice(BigDecimal price1, BigDecimal price2);
//
...
//    List<Movie> getMoviesByPrice(BigDecimal price1, BigDecimal price2);
//
////Write a native query to return all movies where duration exists in the range of duration
//    @Query(value = "SELECT * FROM movie WHERE duration IN ?1", nativeQuery = true)
//    List<Movie> getMoviesByDuration(List<Integer> durations);
//
