...
//    Integer getALlMovieCineamsByCinemaId(Long cinemaId);
//
//    //Write a native query that returns all movie cinemas by location name
//    @Query(value = "SELECT * FROM movie_cinema JOIN  cinema c on c.id = movie_cinema.cinema_id JOIN locacion l on c.location_id = l.id WHERE l.name =?1", nativeQuery = true)
